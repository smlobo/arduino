...
void loop() {
  ...
  myGLCD.print("Hi", CENTER, 50);
  myGLCD.print("Amelia!!", CENTER, 200);
  ...
  // Message
  myGLCD.setColor(255, 255, 255);
  myGLCD.setBackColor(0, 100, 100);
  myGLCD.print("Love,", CENTER, 50);
  myGLCD.print("Dad", CENTER, 200);
